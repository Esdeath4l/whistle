...
export const demoReports: Report[] = [
  {
    id: 'demo_1',
    message: 'Someone was being really rude and using bad language in the office. This is unacceptable behavior.',
    category: 'harassment',
    severity: 'medium',
  ...
  {
    id: 'demo_2', 
    message: 'There was a medical emergency in the building. Someone collapsed and needed immediate help.',
    category: 'medical',
    severity: 'urgent',
  ...
  {
    id: 'demo_3',
    message: 'The security guard was being threatening and said some really scary things. I felt unsafe.',
    category: 'safety',
    severity: 'high',
    ...
    admin_response: 'Thank you for the report. We have investigated the matter and taken appropriate action.',
    admin_response_at: new Date(Date.now() - 10 * 60 * 1000).toISOString()
  },
  {
    id: 'demo_4',
    message: 'Just wanted to provide some feedback about the new lunch menu. It\'s really great!',
    category: 'feedback',
    severity: 'low',
  ...
  {
    id: 'demo_5',
    message: 'Someone was using really offensive language and making threats. This is completely unacceptable and needs to stop now!',
    category: 'harassment',
    severity: 'urgent',
